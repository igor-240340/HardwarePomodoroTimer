...
BLINK:      RCALL LIGHTALL                              ; Индикация.
            ...
            ; NOTE: Максимальное значение ограничиваем 12 часами, т.е. 720 минутами.
...
DIV10FIN:   MOV ARG1, R18                               ; ARG1 = Q.
            ...
            ; Поскольку мы ограничиваем суммарное время активности таймера 12 часами, то значение передаваемого делимого
            ; никогда не превысит 12 * 60 = 720 минут.
            ; При этом, поскольку делитель B всегда равен 60, то значение неполного частного никогда не превысит 12 (0b00001100).
            ...
            ;
            ; Вход:
            ; - ARG1: Младший байт делимого A - суммарное количество минут активности таймера (всегда <= 12 * 60 = 720).
